COLUMNS = {
    ...
    'k': {
        'hiragana': {
            'main': {
                'か': {'sound': 'ka', 'as_in': 'cannes'},
                'き': {'sound': 'ki', 'as_in': 'key'},
                'く': {'sound': 'ku', 'as_in': 'cuckoo'},
                'け': {'sound': 'ke', 'as_in': 'keg'},
                'こ': {'sound': 'ko', 'as_in': 'cold'},
                },
            'dakuten': {
                'が': {'sound': 'ga'},
                'ぎ': {'sound': 'gi'},
    ...
    's': {
        'hiragana': {
            'main': {
                'さ': {'sound': 'sa', 'as_in': 'sign'},
                'し': {'sound': 'shi', 'as_in': 'sheet'},
                'す': {'sound': 'su', 'as_in': 'sue'},
                'せ': {'sound': 'se', 'as_in': 'sexy'},
                'そ': {'sound': 'so', 'as_in': 'soul'},
                },
            'dakuten': {
                'ざ': {'sound': 'za'},
                'じ': {'sound': 'ji'},
    ...
    't': {
        'hiragana': {
            'main': {
                'た': {'sound': 'ta', 'as_in': 'martha'},
                'ち': {'sound': 'chi', 'as_in': 'chin'},
                'つ': {'sound': 'tsu', 'as_in': 'blitz'},
                'て': {'sound': 'te', 'as_in': 'ten'},
                'と': {'sound': 'to', 'as_in': 'thoap'},
                },
            'dakuten': {
                'だ': {'sound': 'da'},
                'ぢ': {'sound': 'di', 'as_in': 'zing'},
                'づ': {'sound': 'du', 'as_in': 'zu'},
                'で': {'sound': 'de'},
                'ど': {'sound': 'do'},
                },
    ...
    'n': {
        'hiragana': {
            'main': {
                'な': {'sound': 'na', 'as_in': 'nambia'},
                'に': {'sound': 'ni', 'as_in': 'needle'},
